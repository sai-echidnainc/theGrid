...
<div class="container-fluid header-container" ng-controller="navController">
	<div class="row-fluid ">
		...
		<div class="grid_btn pull-right">
			...
			?>
				<a href="<?php echo site_url('preview');?>/{{slug}}?mode=admin" target="_blank"><input type="button" value="Preview Grid" class="btn btn-default head_btn" ng-disabled="!gridID"/></a>
				<input type="button" value="{{pBtnTxt}}" class="btn btn-default head_btn" ng-disabled="!gridID" ng-click="publish()" ng-class="{loader: publishLoad}" ng-disabled="publishLoad"/>
